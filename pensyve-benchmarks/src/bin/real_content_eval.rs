...
use pensyve_benchmarks::{BenchmarkConfig, EvalResult, metrics, stats};
...
fn build_memories() -> Vec<MemoryEntry> {
    vec![
        ...
        MemoryEntry {
            topic: "programming",
            content: "Alice said the Rust borrow checker prevents data races at compile time",
        },
        MemoryEntry {
            topic: "programming",
            content: "Bob recommended using tokio for async I/O in the web server",
        },
        MemoryEntry {
            topic: "programming",
            content: "Alice mentioned that PyO3 lets you call Rust from Python with near-zero overhead",
        },
        MemoryEntry {
            topic: "programming",
            content: "The team decided to use SQLite for the offline-first storage backend",
        },
        MemoryEntry {
            topic: "programming",
            content: "Bob warned that mutex contention becomes a bottleneck above 16 threads",
        },
        MemoryEntry {
            topic: "programming",
            content: "Alice explained that HNSW provides O(log n) approximate nearest neighbor search",
        },
        MemoryEntry {
            topic: "programming",
            content: "The CI pipeline runs clippy with pedantic warnings enabled",
        },
        MemoryEntry {
            topic: "programming",
            content: "Bob found that serde_json serialization takes 3x longer than rkyv zero-copy",
        },
        MemoryEntry {
            topic: "programming",
            content: "Alice suggested using criterion for statistically rigorous benchmarks",
        },
        MemoryEntry {
            topic: "programming",
            content: "The team agreed to target ARM64 for the DGX Spark deployment",
        },
        // Cooking (10–19)
        MemoryEntry {
            topic: "cooking",
            content: "Maria shared her sourdough starter recipe that uses rye flour for faster fermentation",
        },
        MemoryEntry {
            topic: "cooking",
            content: "The best temperature for proofing bread dough is between 75-80 degrees Fahrenheit",
        },
        MemoryEntry {
            topic: "cooking",
            content: "Maria recommended using a Dutch oven for the first 20 minutes to trap steam",
        },
        MemoryEntry {
            topic: "cooking",
            content: "For pasta, salt the water until it tastes like the sea — about 1 tablespoon per quart",
        },
        MemoryEntry {
            topic: "cooking",
            content: "The Maillard reaction happens above 280 degrees Fahrenheit and creates the crust flavor",
        },
        MemoryEntry {
            topic: "cooking",
            content: "Maria said to always rest meat for at least 10 minutes after cooking",
        },
        MemoryEntry {
            topic: "cooking",
            content: "Emulsification in vinaigrettes works best when you add oil slowly while whisking",
        },
        MemoryEntry {
            topic: "cooking",
            content: "Fresh herbs should be added at the end of cooking to preserve their volatile oils",
        },
        MemoryEntry {
            topic: "cooking",
            content: "Maria mentioned that brining a turkey for 24 hours makes it significantly more juicy",
        },
        MemoryEntry {
            topic: "cooking",
            content: "The secret to crispy roasted vegetables is high heat and not overcrowding the pan",
        },
        // Travel (20–29)
        MemoryEntry {
            topic: "travel",
            content: "James recommended visiting Kyoto in late March for cherry blossom season",
        },
        MemoryEntry {
            topic: "travel",
            content: "The train from Tokyo to Osaka takes about 2.5 hours on the Shinkansen",
        },
        MemoryEntry {
            topic: "travel",
            content: "James said the best street food in Bangkok is at the Chatuchak weekend market",
        },
        MemoryEntry {
            topic: "travel",
            content: "For hiking in Patagonia, bring layers — weather can change in minutes",
        },
        MemoryEntry {
            topic: "travel",
            content: "James mentioned that Portugal is significantly cheaper than Spain for similar quality",
        },
        MemoryEntry {
            topic: "travel",
            content: "The Northern Lights are best viewed from Tromso, Norway between September and March",
        },
        MemoryEntry {
            topic: "travel",
            content: "James recommended booking Machu Picchu permits at least 3 months in advance",
        },
        MemoryEntry {
            topic: "travel",
            content: "Jet lag recovery takes about one day per time zone crossed",
        },
        MemoryEntry {
            topic: "travel",
            content: "James said the Amalfi Coast drive is beautiful but terrifying in a rental car",
        },
        MemoryEntry {
            topic: "travel",
            content: "For budget travel in Southeast Asia, expect to spend about $30-50 per day",
        },
        // Music (30–39)
        MemoryEntry {
            topic: "music",
            content: "Sarah explained that the ii-V-I progression is the foundation of jazz harmony",
        },
        MemoryEntry {
            topic: "music",
            content: "The major 7th chord creates a dreamy quality because of the half-step dissonance",
        },
        MemoryEntry {
            topic: "music",
            content: "Sarah recommended practicing scales with a metronome starting at 60 BPM",
        },
        MemoryEntry {
            topic: "music",
            content: "The pentatonic scale works over almost any chord and is great for improvisation",
        },
        MemoryEntry {
            topic: "music",
            content: "Sarah said that ear training is more important than learning theory",
        },
        MemoryEntry {
            topic: "music",
            content: "The Circle of Fifths shows how all 12 keys relate to each other",
        },
        MemoryEntry {
            topic: "music",
            content: "Sarah mentioned that using a capo changes the key but preserves open chord voicings",
        },
        MemoryEntry {
            topic: "music",
            content: "Syncopation creates rhythmic tension by emphasizing off-beats",
        },
        MemoryEntry {
            topic: "music",
            content: "Sarah recommended starting with triads before learning extended chords like 9ths and 13ths",
        },
        MemoryEntry {
            topic: "music",
            content: "The blues scale adds a flat 5th to the minor pentatonic for that characteristic sound",
        },
        // Health (40–49)
        MemoryEntry {
            topic: "health",
            content: "Dr. Chen said that consistent sleep schedule matters more than total hours",
        },
        MemoryEntry {
            topic: "health",
            content: "Walking 8000 steps daily reduces all-cause mortality by about 50 percent",
        },
        MemoryEntry {
            topic: "health",
            content: "Dr. Chen recommended strength training at least twice per week for bone density",
        },
        MemoryEntry {
            topic: "health",
            content: "Hydration needs vary — the 8 glasses rule is a myth with no scientific basis",
        },
        MemoryEntry {
            topic: "health",
            content: "Dr. Chen mentioned that meditation reduces cortisol levels measurably within 4 weeks",
        },
        MemoryEntry {
            topic: "health",
            content: "High-intensity interval training provides cardiovascular benefits in less time than steady cardio",
        },
        MemoryEntry {
            topic: "health",
            content: "Dr. Chen said that processed food, not fat or carbs specifically, drives most metabolic disease",
        },
        MemoryEntry {
            topic: "health",
            content: "Vitamin D deficiency is common in northern latitudes and affects immune function",
        },
        MemoryEntry {
            topic: "health",
            content: "Dr. Chen recommended the Mediterranean diet as the most evidence-backed eating pattern",
        },
        MemoryEntry {
            topic: "health",
            content: "Cold exposure through cold showers activates brown fat and may improve metabolism",
        },
    ]
}
...
fn build_queries() -> Vec<QueryEntry> {
    vec![
        // Easy (direct match)
        QueryEntry {
            query: "What did Alice say about the borrow checker?",
            gold_indices: vec![0],
            difficulty: "easy",
        },
        QueryEntry {
            query: "What temperature is best for proofing bread?",
            gold_indices: vec![11],
            difficulty: "easy",
        },
        QueryEntry {
            query: "When should you visit Kyoto?",
            gold_indices: vec![20],
            difficulty: "easy",
        },
        QueryEntry {
            query: "What is the ii-V-I progression?",
            gold_indices: vec![30],
            difficulty: "easy",
        },
        // Medium (requires entity/topic matching)
        QueryEntry {
            query: "What did Bob recommend for async programming?",
            gold_indices: vec![1],
            difficulty: "medium",
        },
        QueryEntry {
            query: "How does Maria make her bread crusty?",
            gold_indices: vec![12, 14],
            difficulty: "medium",
        },
        QueryEntry {
            query: "What are James's tips for Japan?",
            gold_indices: vec![20, 21],
            difficulty: "medium",
        },
        QueryEntry {
            query: "What scales should a beginner learn?",
            gold_indices: vec![33, 38],
            difficulty: "medium",
        },
        // Hard (cross-topic, temporal, or requires inference)
        QueryEntry {
            query: "What advice involves the number 60?",
            gold_indices: vec![8, 32],
            difficulty: "hard",
        },
        QueryEntry {
            query: "What has scientific evidence behind it?",
            gold_indices: vec![41, 43, 44, 48],
            difficulty: "hard",
        },
        QueryEntry {
            query: "What should I do before cooking something?",
            gold_indices: vec![15, 18],
            difficulty: "hard",
        },
        QueryEntry {
            query: "Who gave advice about performance optimization?",
            gold_indices: vec![1, 4, 5, 7],
            difficulty: "hard",
        },
        // Cross-domain
        QueryEntry {
            query: "What involves temperature?",
            gold_indices: vec![11, 14, 49],
            difficulty: "hard",
        },
        QueryEntry {
            query: "What did women specifically recommend?",
            gold_indices: vec![0, 2, 5, 8, 10, 12, 18, 30, 32, 34, 36, 38],
            difficulty: "hard",
        },
        // Recall-type
        QueryEntry {
        ...
        QueryEntry {
            query: "What did Dr. Chen say about sleep?",
            gold_indices: vec![40],
            difficulty: "easy",
        },
        QueryEntry {
            query: "What recipe did Maria share?",
            gold_indices: vec![10],
            difficulty: "easy",
        },
        QueryEntry {
            query: "What did Sarah say about ear training?",
            gold_indices: vec![34],
            difficulty: "easy",
        },
        // Action-type
        QueryEntry {
            query: "How do I make crispy roasted vegetables?",
            gold_indices: vec![19],
            difficulty: "medium",
        },
        QueryEntry {
            query: "How should I prepare for hiking in Patagonia?",
            gold_indices: vec![23],
            difficulty: "medium",
        },
    ]
...
fn evaluate_retrieval(top_ids: &[Uuid], gold_memory_ids: &[Uuid], difficulty: &str) -> QueryResult {
    let top_k = 5;
...
fn evaluate_v1_retrieval(
    ...
    let top_k = 5;
    let relevant_at: Vec<bool> = ranked
        .iter()
        .take(top_k)
...
fn main() {
    ...
    let (embedder, using_real) = match OnnxEmbedder::new("all-MiniLM-L6-v2") {
        ...
        Err(err) => {
            eprintln!("WARNING: ONNX embedder failed ({err}), falling back to mock");
    ...
    let memory_embeddings: Vec<Vec<f32>> = memory_contents
        .iter()
    ...
    for (i, mem_entry) in memories.iter().enumerate() {
        let about_entity = topic_entities
            .get(mem_entry.topic)
        ...
        emem.embedding.clone_from(&memory_embeddings[i]);
        storage
            .save_episodic(&emem)
    ...
    for (qi, query_entry) in queries.iter().enumerate() {
        let gold_ids: Vec<Uuid> = query_entry
            .gold_indices
            .iter()
        ...
        match engine.recall(query_entry.query, ns.id, 5) {
            Ok(result) => {
                let top_ids: Vec<Uuid> = result.memories.iter().map(|sc| sc.memory_id).collect();
                v2_results.push(evaluate_retrieval(
                    &top_ids,
                    &gold_ids,
                    query_entry.difficulty,
                ));
            }
            Err(e) => {
                eprintln!("  Query {qi}: recall error: {e}");
    ...
    for (qi, query_entry) in queries.iter().enumerate() {
        ...
        v1_results.push(evaluate_v1_retrieval(
            &ranked,
            &query_entry.gold_indices,
            query_entry.difficulty,
        ));
    }
    ...
    if !using_real {
        println!(
            "*** WARNING: Using mock embeddings — results are not semantically meaningful ***"
        );
    }
    println!("{}", "=".repeat(60));
    ...
    let ci =
        |v: &[f64]| stats::bootstrap_ci(v, config.bootstrap_resamples, 0.05, config.random_seed);

    println!("\nv2 RRF Pipeline:");
    let (acc_lo, acc_hi) = ci(&v2_acc);
    println!(
        "  Accuracy@1: {:.3} [{:.3}, {:.3}] (95% CI)",
        mean(&v2_acc),
        acc_lo,
        acc_hi
    );
    ...
    for difficulty in &["easy", "medium", "hard"] {
        let filtered: Vec<f64> = v2_results
            .iter()
        ...
        if !filtered.is_empty() {
            let diff_mrr: Vec<f64> = v2_results
                .iter()
                .filter(|r| r.difficulty == *difficulty)
                .map(|r| r.mrr)
                .collect();
            let diff_recall: Vec<f64> = v2_results
                .iter()
                .filter(|r| r.difficulty == *difficulty)
                .map(|r| r.recall_at_5)
                .collect();
            println!(
                "  {:6} (n={:2}): Acc@1 = {:.2}, MRR = {:.2}, Recall@5 = {:.2}",
                difficulty,
                n,
                mean(&filtered),
                mean(&diff_mrr),
    ...
    println!(
        "  v1 linear fusion: Accuracy@1 = {:.2}, MRR = {:.2}",
        mean(&v1_acc),
        mean(&v1_mrr)
    );
    println!(
        "  v2 RRF pipeline:  Accuracy@1 = {:.2}, MRR = {:.2}",
        mean(&v2_acc),
        mean(&v2_mrr)
    );
    ...
    let ablation = vec![
        ...
        AblationResult {
            metric: "ndcg_at_5".into(),
            v1_mean: mean(&v1_ndcg),
            v2_mean: mean(&v2_ndcg),
            cohens_d: d_ndcg,
            wilcoxon_p: p_ndcg,
        },
        AblationResult {
            metric: "recall_at_5".into(),
            v1_mean: mean(&v1_recall),
            v2_mean: mean(&v2_recall),
            cohens_d: d_recall,
            wilcoxon_p: p_recall,
        },
    ];
    ...
    let per_query: Vec<PerQueryResult> = queries
        .iter()
        .enumerate()
