# Pensyve for JetBrains AI Assistant
...
Pensyve uses a tiered classification system to identify what is worth remembering. Since JetBrains AI Assistant connects via MCP, the LLM follows the MCP tool descriptions to decide when and how to call memory tools.
