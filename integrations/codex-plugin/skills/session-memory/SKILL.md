---
name: session-memory
description: "End-of-session memory capture — analyzes session for decisions, outcomes, and patterns worth remembering"
---
...
- **All memory operations go through the Pensyve MCP tools exclusively.** Do not write to the local filesystem or any other storage mechanism.
