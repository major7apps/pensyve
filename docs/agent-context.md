...
Long-form companion to [`AGENTS.md`](../AGENTS.md) — full build commands, architecture, conventions, environment variables, and test counts. Shared across all agentic harnesses (Claude Code, Codex, Cursor, Aider, etc.). For the short table-of-contents view, read [`AGENTS.md`](../AGENTS.md) first.
